...
const EditEmployee = ({ employee, onSubmit }) => {
  ...
  return (
    <Container>
      <Form
        onSubmit={e =>
          onSubmit(e, firstname, lastname, telephone, hireDate, checked)
        }
      >
        ...
        <FormGroup>
          ...
          <Input
            ...
            value={`${telephone}`}
            onChange={() =>
              setTelephone(document.getElementById('telephone').value)
            }
          />
        </FormGroup>
        <Row form>
          <FormGroup>
            ...
            <Input
              ...
              value={`${hireDate}`}
              onChange={() =>
                setHireDate(document.getElementById('hireDate').value)
              }
              required
            />
          </FormGroup>
